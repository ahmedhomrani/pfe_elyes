...
from .views import ChangePasswordView, DeactivateUserView, UpdateUserView, UserList, AuthUserLoginView, DeleteUserView
...
urlpatterns = [
    ...
    path('auth/delete-user/<int:pk>/', DeleteUserView.as_view(), name="delete_user"),
]